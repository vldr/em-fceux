...
INPUT(0x0106, 0x030, 0x00, SYSTEM_STATE_SELECT_0, "Select State 0") // 0-9
INPUT(0x0107, 0x031, 0x00, SYSTEM_STATE_SELECT_1, "Select State 1") // ...
INPUT(0x0108, 0x032, 0x00, SYSTEM_STATE_SELECT_2, "Select State 2")
INPUT(0x0109, 0x033, 0x00, SYSTEM_STATE_SELECT_3, "Select State 3")
INPUT(0x010A, 0x034, 0x00, SYSTEM_STATE_SELECT_4, "Select State 4")
INPUT(0x010B, 0x035, 0x00, SYSTEM_STATE_SELECT_5, "Select State 5")
INPUT(0x010C, 0x036, 0x00, SYSTEM_STATE_SELECT_6, "Select State 6")
INPUT(0x010D, 0x037, 0x00, SYSTEM_STATE_SELECT_7, "Select State 7")
INPUT(0x010E, 0x038, 0x00, SYSTEM_STATE_SELECT_8, "Select State 8")
INPUT(0x010F, 0x039, 0x00, SYSTEM_STATE_SELECT_9, "Select State 9")
// Controller 1
